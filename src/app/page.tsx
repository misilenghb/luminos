...
import { Wand2, BarChartBig, Zap } from 'lucide-react';
    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-150px)] text-center p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 opacity-20">
        <Image 
          ...
          alt="Abstract crystal background" 
          fill
          style={{ objectFit: 'cover' }}
          className="blur-md"
          data-ai-hint="abstract crystal" 
        />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center">
        <Wand2 className="w-16 h-16 text-accent mb-6 animate-bounce" />
