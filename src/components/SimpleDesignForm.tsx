      ...
      <CardContent>
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
            <div>
              ...
              />
              {errors.designCategory && <p className="text-destructive text-sm mt-1">{t(errors.designCategory.message || 'validation.required')}</p>}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    />
                    {errors.mainCrystal1 && <p className="text-destructive text-sm mt-1">{t(errors.mainCrystal1.message || 'validation.required')}</p>}
                </div>
                <div>
                    ...
                    />
                                         {errors.mainCrystal1Color && <p className="text-destructive text-sm mt-1">{t(errors.mainCrystal1Color.message || 'validation.required')}</p>}
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    />
                    {errors.mainCrystal2 && <p className="text-destructive text-sm mt-1">{t(errors.mainCrystal2.message || 'validation.required')}</p>}
                </div>
                <div>
            ...
            <div>
              ...
              />
              {errors.overallDesignStyle && <p className="text-destructive text-sm mt-1">{t(errors.overallDesignStyle.message || 'validation.required')}</p>}
            </div>
            ...
            <div>
              ...
              />
              {errors.userIntent && <p className="text-destructive text-sm mt-1">{t(errors.userIntent.message || 'validation.required')}</p>}
            </div>
